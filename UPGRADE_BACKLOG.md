...
- ✅ **OKAMI input form** — `/okami-capacity` dashboard page (DAs, Okami, Capacity + 4x4, Vans); `mgt_reminders.py`'s "okami" reminder now resolves off a same-day form submission instead of a file upload (2026-07-14)
